<template>
<uni-shadow-root class="vant-weapp-sticky-index"><view class="custom-class van-sticky" :style="'z-index: '+(zIndex)+'; '+(containerStyle)">
...
global['__wxRoute'] = 'vant-weapp/sticky/index'
...
export default global['__wxComponents']['vant-weapp/sticky/index']
</script>
<style platform="mp-weixin">
@import '../common/index.css';.van-sticky{position:relative}
</style>
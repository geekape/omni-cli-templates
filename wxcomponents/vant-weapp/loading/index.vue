<template>
<uni-shadow-root class="vant-weapp-loading-index"><view class="van-loading custom-class" :style="'width: '+(sizeWithUnit)+'; height: '+(sizeWithUnit)">
...
global['__wxRoute'] = 'vant-weapp/loading/index'

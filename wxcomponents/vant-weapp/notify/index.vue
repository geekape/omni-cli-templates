<template>
<uni-shadow-root class="vant-weapp-notify-index"><van-transition name="slide-down" :show="show" :custom-class="'van-notify van-notify--'+(type)" :custom-style="'background:'+(background)+'; color: '+(color)+'; z-index: '+(zIndex)+';'" @click.native="onTap">

<template>
<uni-shadow-root class="vant-weapp-tab-index"><view v-if="animated || inited" :class="'custom-class '+(utils.bem('tab__pane', { active, inactive: !active }))" :style="(animated || active ? '' : 'display: none;')+' '+(width ? 'width:' + width + 'px;' : '')">
  <slot></slot>

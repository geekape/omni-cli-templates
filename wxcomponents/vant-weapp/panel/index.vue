<template>
<uni-shadow-root class="vant-weapp-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = 'vant-weapp/panel/index'
...
@import '../common/index.css';.van-panel{background:#fff;background:var(--white,#fff)}.van-panel__header-value{color:#ee0a24;color:var(--red,#ee0a24)}.van-panel__footer{padding:10px 15px}
</style>
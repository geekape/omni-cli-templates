...
/* 4 */
/*!************************************************!*\
  !*** /Users/doc/code/omni-template/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!*****************************************************************!*\
  !*** /Users/doc/code/omni-template/pages.json?{"type":"style"} ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "uni-app", "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),
/* 8 */
/*!****************************************************************!*\
  !*** /Users/doc/code/omni-template/pages.json?{"type":"stat"} ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__4101D10" };exports.default = _default;
...
/* 25 */
/*!****************************************************!*\
  !*** /Users/doc/code/omni-template/store/index.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* 27 */
/*!**************************************************!*\
  !*** /Users/doc/code/omni-template/lib/utils.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 29 */
/*!********************************************************!*\
  !*** /Users/doc/code/omni-template/api/module/user.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! ../config */ 30));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
...
/* 30 */
/*!***************************************************!*\
  !*** /Users/doc/code/omni-template/api/config.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request */ 31));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* 31 */
/*!****************************************************!*\
  !*** /Users/doc/code/omni-template/api/request.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Request = /*#__PURE__*/function () {function Request() {_classCallCheck(this, Request);_defineProperty(this, "config",
      ...
      if (res.statusCode >= 200 && res.statusCode <= 302) {// http ok
        ...
        if (that.interceptor.response && typeof that.interceptor.response === 'function' && !skip) {
          ...
          if (_config.businessSuccess /* || result.success*/) {// 不兼容原来的接口业务逻辑调用成功判定
              ...
              if (_config.debug) {
                console.log("response(".concat(_config.url, ") success: "), _data);
              }
          ...
          if (_config.debug) {
            console.log("response(".concat(_config.url, ") success: "), result);
          }
    ...
    function (that, _config, res, resolve, reject) {
      if (_config.debug) {
        console.error("response(".concat(_config.url, ") failure: "), res);
      }
    ...
    function (that, _config) {var obj = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      if (_config.debug) {
        console.log("request(".concat(_config.url, "): "), _config);
      }
    ...
    function (that, _config, res) {var obj = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
      ...
      if (_config.debug) {
        console.log("request(".concat(_config.url, ") completed in ").concat(obj.endTime - obj.startTime, " ms"));
      }
      if (_config.loadingTip) {
      ...
      if (_config.complete) {
        _config.complete(res);
                                                    ...
                                                    */value: function setConfig(config) {this.config = Object.assign(this.config, config);} }, { key: "request", value: function request() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var that = this;if (options.data === undefined) {options.data = {};}if (options.header === undefined) {options.header = {};}var _options = Object.assign({}, this.config, options);_options = Object.assign(options, _options);_options.url = Request.getUrl(_options);if (!_options.header['Content-Type']) {_options.header['Content-Type'] = Request.getContentType(_options);}var _config = _options;if (that.interceptor.request && typeof that.interceptor.request === 'function') {_config = that.interceptor.request(_options);}var task = undefined;var promise = new Promise(function (resolve, reject) {var extras = {};that._prepare(that, _config, extras);if (_config.contentType === 'file') {task = uni.uploadFile(_objectSpread({}, _config, { success: function success(res) {that._success(that, _config, res, resolve, reject);}, fail: function fail(res) {that._fail(that, _config, res, resolve, reject);}, complete: function complete(res) {that._complete(that, _config, res, extras);} }));if (_config.progress && typeof _config.progress === 'function') {task.onProgressUpdate(function (_res) {_config.progress(_res, task);});}} else {task = uni.request(_objectSpread({}, _config, { success: function success(res) {that._success(that, _config, res, resolve, reject);}, fail: function fail(res) {that._fail(that, _config, res, resolve, reject);}, complete: function complete(res) {that._complete(that, _config, res, extras);} }));}});if (_config.success || _config.fail || _config.complete) {return task;}return promise;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           */ }, { key: "get", value: function get() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};options.method = 'GET';debugger;return this.request(options);} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * @method
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */ }, { key: "post", value: function post() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};options.method = 'POST';return this.request(options);} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        * author by wyh
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */ }, { key: "put", value: function put() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};options.method = 'PUT';return this.request(options);} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * author by wyh
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */ }, { key: "delete", value: function _delete() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};options.method = 'DELETE';return this.request(options);} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @method
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @description execute a get request
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @param {Object} options - 参数选项
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @param {string} options.url - 请求地址
...
/* 32 */
/*!**********************************************************!*\
  !*** /Users/doc/code/omni-template/api/module/common.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
